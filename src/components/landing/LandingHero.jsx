    ...
    whatsapp: (
      <span className="brand-icon whatsapp-icon">
        <svg viewBox="0 0 40 40" aria-hidden="true">
          ...
          <path d="M11.2 29.1 13 23.2a10.9 10.9 0 1 1 4.3 4l-6.1 1.9Z" fill="#fff" />
          <path d="M15.4 14.1c-.4-.9-.7-.9-1.1-.9h-.9c-.4 0-.8.1-1.1.6-.4.5-1.3 1.3-1.3 3.2s1.3 3.7 1.5 3.9c.2.3 2.5 4 6.2 5.5 3.1 1.3 3.8 1 4.5 1 .8-.1 2.4-1 2.8-1.9.3-.9.3-1.7.2-1.9-.1-.2-.4-.3-.9-.6-.5-.2-2.5-1.2-2.9-1.3-.4-.2-.7-.2-.9.2-.3.5-1 1.3-1.2 1.6-.2.3-.5.3-.9.1-.5-.2-1.8-.7-3.3-2-1.2-1-2-2.2-2.2-2.6-.2-.5 0-.7.2-.9.2-.2.5-.6.7-.8.2-.3.3-.5.4-.8.1-.3 0-.6-.1-.9-.2-.4-1-2.4-1.3-2.7Z" fill="#25D366" />
        </svg>
      </span>
    ),
...
function CountryFlag({ code, currency, accent }) {
  const flag = {
    ...
    JP: <><rect width="36" height="24" fill="#fff" /><circle cx="18" cy="12" r="7" fill="#bc243c" /></>,
    SG: <><rect width="36" height="12" fill="#d71920" /><rect y="12" width="36" height="12" fill="#fff" /><circle cx="9" cy="6" r="4" fill="#fff"/><circle cx="10.5" cy="6" r="3.1" fill="#d71920" /></>,
