      ...
      <div className="hero-inner">
        <div className="hero-copy">
          ...
          <p className="copy-body">
            Xspendzon makes sharing expenses with Business,friends, roommates,
            family, and travel groups effortless. Create a group, add expenses,
            and let Xspendzon handle the math — so you can focus on the people,
            not the payments.
          </p>
            ...
            <button className="store-button" type="button">
              <span className="store-icon play-icon" aria-hidden="true">
                <svg viewBox="0 0 24 24">
                  <path
                    d="M3.3 2.9 14.2 12 3.3 21.1c-.2-.4-.3-.9-.3-1.5V4.4c0-.6.1-1.1.3-1.5Z"
                    fill="#0f90cc"
                  />
                  <path
                    d="m14.2 12 3.4-2.8 2.6 1.5c.7.4.7 1.1 0 1.5l-2.6 1.5-3.4-2.7Z"
                    fill="#ef8009"
                  />
                  <path d="m3.3 2.9 13.3 6.3-2.4 2.8L3.3 2.9Z" fill="#0bb535" />
                  <path
                    d="m3.3 21.1 10.9-9.1 2.4 2.7-13.3 6.4Z"
                    fill="#ef5350"
                  />
                </svg>
              </span>
              <span className="store-copy">
                <small>GET IT ON</small>
                <strong>Google Playstore</strong>
              </span>
            </button>
          </div>
  ...
  const icons = {
    ...
    telegram: (
      <span className="brand-icon telegram-icon">
        <svg viewBox="0 0 40 40" aria-hidden="true">
          ...
          <path
            d="M30.1 10.2 25.2 29c-.4 1.4-1.1 1.7-2.2 1.1l-6-4.4-2.9 2.8c-.3.3-.6.6-1.2.6l.4-6.1 11.2-10.1c.5-.5-.1-.7-.8-.2L10 21.4l-6-1.9c-1.3-.4-1.3-1.3.3-1.9l23.1-8.9c1.1-.4 2 .2 1.7 1.5Z"
            fill="#fff"
          />
        </svg>
      </span>
    ...
    notification: (
      <span className="brand-icon notification-icon">
        <svg viewBox="0 0 40 40" aria-hidden="true">
          <path
            d="M20 35a4.2 4.2 0 0 0 4-3h-8a4.2 4.2 0 0 0 4 3Z"
            fill="currentColor"
          />
          <path
            d="M31.2 27.3 28.8 24V16a8.8 8.8 0 0 0-7-8.5V6.3a1.8 1.8 0 1 0-3.6 0v1.2a8.8 8.8 0 0 0-7 8.5v8l-2.4 3.3c-.8 1.1 0 2.5 1.4 2.5h19.6c1.4 0 2.2-1.4 1.4-2.5Z"
            fill="currentColor"
          />
        </svg>
      </span>
...
function CountryFlag({ code, currency, accent }) {
  const flag = {
    ...
    GB: (
      <>
        <rect width="36" height="24" fill="#2447a8" />
    ...
    EU: (
      <>
        <rect width="36" height="24" rx="2" fill="#1647a5" />
        <g fill="#ffd34d">
    ...
    CA: (
      <>
        <rect width="36" height="24" fill="#fff" />
        <rect width="9" height="24" fill="#d52b1e" />
        <rect x="27" width="9" height="24" fill="#d52b1e" />
        <path
          d="m18 5 1.7 5 4-2-2 4.1 3.7 2.4-4.7.5.5 4.6-3.2-3-3.2 3 .5-4.6-4.7-.5 3.7-2.4-2-4.1 4 2L18 5Z"
          fill="#d52b1e"
        />
      </>
    ),
    AU: (
      <>
        <rect width="36" height="24" fill="#1f3f9f" />
        <rect width="17" height="12" fill="#2447a8" />
        <path d="M0 0 17 12M17 0 0 12" stroke="#fff" strokeWidth="4" />
        <path d="M8.5 0v12M0 6h17" stroke="#fff" strokeWidth="5" />
        <path d="M8.5 0v12M0 6h17" stroke="#cf142b" strokeWidth="2.5" />
        <circle cx="27" cy="8" r="2" fill="#fff" />
        <circle cx="31" cy="13" r="1.4" fill="#fff" />
        <circle cx="25" cy="16" r="1.2" fill="#fff" />
      </>
    ),
    JP: (
      <>
        <rect width="36" height="24" fill="#fff" />
        <circle cx="18" cy="12" r="7" fill="#bc243c" />
      </>
    ),
    SG: (
      <>
        <rect width="36" height="12" fill="#d71920" />
        <rect y="12" width="36" height="12" fill="#fff" />
        <circle cx="9" cy="6" r="4" fill="#fff" />
        <circle cx="10.5" cy="6" r="3.1" fill="#d71920" />
      </>
    ),
    AE: (
      <>
        <rect width="36" height="8" fill="#14805d" />
        <rect y="8" width="36" height="8" fill="#fff" />
        <rect y="16" width="36" height="8" fill="#111" />
        <rect width="8" height="24" fill="#d82027" />
      </>
    ),
  }[code];
          ...
          <div className="expense-chart-card">
            ...
            <div className="chart-area">
              ...
              <div className="chart-legend">
                ...
                <span>
                  <i className="dot shopping" />
                  Shopping <b>18%</b>
                </span>
                <span>
                  <i className="dot utilities" />
                  Utilities <b>12%</b>
                </span>
                <span>
                  <i className="dot entertainment" />
                  Entertainment <b>8%</b>
                </span>
                <span>
                  <i className="dot others" />
                  Others <b>6%</b>
                </span>
              </div>
            </div>
...
function DonutChart() {
  const segments = [
    { value: 32, color: "#16b8d4" },
    { value: 24, color: "#18c67a" },
    { value: 18, color: "#ffad2f" },
    { value: 12, color: "#8d55dc" },
    { value: 8, color: "#f05b76" },
    { value: 6, color: "#7792b7" },
  ];
  const radius = 42;
  ...
  return (
    <svg className="donut-chart" viewBox="0 0 110 110" aria-hidden="true">
      ...
      <text x="55" y="52" textAnchor="middle" className="donut-total">
        ₹12.4L
      </text>
      <text x="55" y="65" textAnchor="middle" className="donut-caption">
        total
      </text>
    </svg>
  );
        ...
        <div className="phone-screen">
          ...
          <div className="phone-header">
            <div className="phone-brand">
              <span className="phone-logo">X</span>
              <strong>Xspendzon</strong>
            </div>
            <span className="phone-bell">♧</span>
          </div>
          <div className="phone-greeting">
            <small>Hi, Alex 👋</small>
            <strong>Let's settle up!</strong>
          </div>
          <div className="balance-card">
            <div>
              <small>Total balance</small>
              <strong>₹ 12,48,500</strong>
